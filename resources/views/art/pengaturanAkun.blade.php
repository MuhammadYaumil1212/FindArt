        ...
        <div class="card-body">
            ...
            <form method="post" id="form-setting">
				...
				<div class="form-group mt-2">
					...
					<select type="text" name="provinsi" class="form-control" id="provinsi" required>
				...
				<div class="form-group mt-2">
					...
					<select type="text" name="kota" class="form-control" id="kota" required>
                        <option value="1">Contoh</option>
                        <option value="2">Contoh</option>
                        <option value="3">Contoh</option>
                    </select>
				...
				<div class="form-group mt-2">
					...
					<select type="text" name="kecamatan" class="form-control" id="kecamatan" required>
                        <option value="1">Contoh</option>
                        <option value="2">Contoh</option>
                        <option value="3">Contoh</option>
                    </select>
				...
				<div class="form-group mt-2">
					...
					<select type="text" name="kelurahan" class="form-control" id="kelurahan" required>
                        <option value="1">Contoh</option>
                        <option value="2">Contoh</option>
                        <option value="3">Contoh</option>
                    </select>
